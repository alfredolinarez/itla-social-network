  ...
  <div class="container">
    <div class="row content">
      <div class="col-md-12">
        ...
        <form class="needs-validation" novalidate action="{{ route('register') }}" method="POST" name="f1">
          @csrf

          @if($user_exists ?? '')
            <div class="alert alert-danger">Este nombre de usuario ya está siendo utilizado.</div>
          @endif
          ...
          <div class="form-group">
            ...
            <div class="invalid-feedback">Complete el campo</div>
            <div id="mensaje" style="display: none;" class="error">Las claves no coinciden</div>
          </div>
          <div class="buttons1">
      ...
      window.addEventListener('load', function() {
        ...
        var validation = Array.prototype.filter.call(forms, function(form) {
          form.addEventListener('submit', function(event) {
            ...
            const $verify_password = $('input[name="verify_password"]');

            if($password.val() !== $verify_password.val() && $verify_password.val()) {
              $('#mensaje').show();
